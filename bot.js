...
switch(comando) {
    ...
    case "link":
          ...
          if(args == "fs%") {
            message.channel.send("https://docs.google.com/spreadsheets/d/1JfYm6ZNy9oUlYr_Su6nTiQwK8tjp5jvbUflW_yRaLec/htmlview?sle=true#gid=1237901118");
          }
          ExibeLog(message, args, message.author.username);
    break;
  case "askme":
  ...
  case "boss":
        ...
        var bosses = ["Kzarka","kutum","Nouver","Karanda","Garmoth","Offin","Vell","Quint & Muraka"];
        var x = Math.floor(Math.random()*8);
        message.channel.send(`${bosses[x]} irá spawnar em ${tempo} minutos`);
        break;
  case "merda":
        message.channel.send("Falou pouco mas falou bosta");
        break;
  case "timetoroll":
        var tempo = Math.floor(Math.random()*6000)+1;
        message.channel.send(`Tempo para o guki rolar o boneco: ${tempo} segundos`);
        break;
  case "fbiagainstgoya":
        message.channel.send(`https://gfycat.com/admirabledecisiveinchworm`);
        break;
}
